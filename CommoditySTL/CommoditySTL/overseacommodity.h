...
public:
    ...
    OverseaCommodity(long id,std::string name,double p=0,int n=0,double d=1.0,double t=0);
    OverseaCommodity(std::string name,double p=0,int n=0,double d=1.0,double t=0);
