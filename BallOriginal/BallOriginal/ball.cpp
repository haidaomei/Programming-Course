...
Ball::Ball(double xpos,double ypos,double r,double s,double a,QColor c):x(xpos),y(ypos),radius(r),speed(s),angle(a),color(c)
{
}
...
void Ball::setRectangle(const QRect &rect)
{
    this->rect=rect;
}
